...
#include "CommonProfilerEditorMode.generated.h"
 ...
 */
UCLASS()
class UCommonProfilerEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_CommonProfilerEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UCommonProfilerEditorMode();
	virtual ~UCommonProfilerEditorMode();
