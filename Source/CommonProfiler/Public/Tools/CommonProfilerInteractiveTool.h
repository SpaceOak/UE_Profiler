...
#include "CommonProfilerInteractiveTool.generated.h"


/**
 * Builder for UCommonProfilerInteractiveTool
 */
UCLASS()
class COMMONPROFILER_API UCommonProfilerInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UCommonProfilerInteractiveTool
 */
UCLASS(Transient)
class COMMONPROFILER_API UCommonProfilerInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UCommonProfilerInteractiveToolProperties();
...
/**
 * UCommonProfilerInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class COMMONPROFILER_API UCommonProfilerInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UCommonProfilerInteractiveToolProperties> Properties;
